...
void CalculateB(const GaugeField& Gluon)
{
...
void CalculateLambda(const GaugeField& Gluon, GaugeField& Lambda)
{
...
void StoutSmearing4DWithForce(const GaugeField>& Gluon_unsmeared, GaugeField& Gluon_smeared, const floatT smear_param = 0.12)
{
    Matrix_3x3 st;
    Matrix_3x3 A;
    Matrix_3x3 B;
